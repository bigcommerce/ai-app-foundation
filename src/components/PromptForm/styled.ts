...
export const StyledButton = styled.button<{ isActive: boolean }>`
    align-items: center;
    appearance: none;
    background-color: ${({ isActive, theme }) => (isActive ? theme.colors.primary20 : theme.colors.white)};
    border-top: ${({ theme }) => theme.border.box};
    border-left: ${({ theme }) => theme.border.box};
    border-bottom: ${({ theme }) => theme.border.box};
    border-color: ${({ isActive, theme }) => (isActive ? theme.colors.primary30 : theme.colors.secondary30)};
    border-right: 0;
    border-radius: 0;
    ...
    &:last-child {
        ...
        border-right-color: ${({ isActive, theme }) => (isActive ? theme.colors.primary30 : theme.colors.secondary30)};
    }
