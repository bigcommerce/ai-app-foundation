...
export function bigcommerceClient(accessToken: string, storeHash: string, apiVersion = 'v3'): BigCommerce {
...
export function decodePayload(encodedContext: string): any {
